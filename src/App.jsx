    ...
    <Router basename="/React">
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/NFTComponent" element={<UploadAndMintNFT />} />{" "}
          {/* Upload record and mint NFT */}
          ...
          <Route
            path="/RejectedNotification"
            element={<RejectedNotification />}
          />
          <Route
            path="/AcceptedNotification"
            element={<AcceptedNotification />}
          />
        </Routes>
        <Footer />
      </div>
