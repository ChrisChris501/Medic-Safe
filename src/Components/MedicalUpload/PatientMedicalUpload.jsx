...
const contractABI = [MedicalNFT.abi];
        ...
        <div className="DoctorProfileSecondLinks">
          <Link to="/Privacy_Security">
            <button key="PrivacyPolicy">
              <FontAwesomeIcon icon={faHandHoldingUsd} /> Privacy Policy
            </button>
            <br />
          </Link>
          <Link to="/Settings">
          ...
          <Link to="/LogOut">
            <button key="Logout">
              <FontAwesomeIcon icon={faQuestion} /> Logout
            </button>
            <br />
          </Link>
        </div>
      ...
      <div className="TheDoctorDetails">
        ...
        <div className="TheUploadDetails">
          ...
          <div className="SaveDoc">
            <h4>
              <FontAwesomeIcon icon={faSync} /> Saving
            </h4>
          </div>
        </div>
      </div>
